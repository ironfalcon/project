...
<div class="admin-container">
    <div class="container" style="padding-top:20px;">
                ...
                <div class="row">
                            <div class="row pb-3">
                                <div class="col-md-12 text-right">
                                    <a href="#" data-toggle="modal" data-target="#addDocs" class="btn btn-warning">Добавить</a>
                                </div>
                            </div>
                            <div class="container">
                                <div class="row">
                                @foreach($allDocs as $Docs)
                                    <div class="col-md-4 text-center" style="padding:2px;">
                                        <div style="border: solid 1px rgb(50, 167, 237);">
                                            <img src="{{asset('files/img/docs/'.$Docs->img)}}" height="200px" >
                                        </div>
                                        <div class="col-md-12 admin-icons-prod text-right">
                                            <!-- форма удаления -->
                                            {!! Form::open(['method' => 'DELETE', 'route' => ['admin.docs.delete', $Docs->id] ])!!}
                                            {{ csrf_field() }}
        ...
        <div class="modal fade" id="addDocs" role="dialog">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-left">
                        <form enctype="multipart/form-data" action="{{ route('admin.docs.add') }}" method="POST">
                            {{ csrf_field() }}
